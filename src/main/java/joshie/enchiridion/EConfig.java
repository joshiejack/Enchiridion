...
public class EConfig {
    ...
    public static void init(Configuration config) {
        try {
            ...
            ENABLE_BOOKS = config.get("Settings", "Enable Book Item", true).getBoolean(true);
            ENABLE_WIKI = config.get("Settings", "Enable Wiki & Library", true).getBoolean(true);
            ...
            DEFAULT_MOD = config.get("Settings", "Default Mod", "Enchiridion 2").getString();
