...
public class EConfig {
    ...
    public static void init(Configuration config) {
        try {
            config.load();
            String[] color_list = config.get("Settings", "Edit Mode Colours", default_colors, "This is a list of the colours to show up in edit mode by default").getStringList();
            ...
            DISABLE_AUTODISCOVERY = config.get("Settings", "Disable Autodiscovery", false, "Enchiridion 2 searches the jars of all mods by default for pedia articles, if your load time is long, disable this and it might help reduce the load time.").getBoolean(false);
