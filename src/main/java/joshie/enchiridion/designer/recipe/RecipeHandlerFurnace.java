...
public class RecipeHandlerFurnace extends RecipeHandlerBase {
    ...
    protected void drawBackground() {
        ...
        EnchiridionAPI.draw.drawTexturedRect(55D, 38D, 1, 63, 20, 14, 1.75F);
        int i1 = getBurnTimeRemainingScaled(13);
        EnchiridionAPI.draw.drawTexturedReversedRect(44D, 56D, 0, 85, 14, 14, 1.75F);
        EnchiridionAPI.draw.drawTexturedReversedRect(44D, 46D + 12D, 14, 98 - i1, 14, i1 + 1, 1.75F);
    }
}
